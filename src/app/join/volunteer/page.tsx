        ...
        <div className="w-full max-w-4xl grid lg:grid-cols-[1fr_480px] gap-12 items-center">
            ...
            <div className="hidden lg:flex flex-col space-y-10">
                ...
                <div className="space-y-6">
                    ...
                    {[
                        { icon: Heart, text: "Make a direct impact in your community" },
                        { icon: Star, text: "Gain professional experience and skills" },
                        { icon: User, text: "Be part of a global movement" }
                    ].map((item, idx) => (
                    ...
                    {step === 2 && (
                        <motion.div key="step2" {...stepVariants}>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="space-y-2">
                                    <Label htmlFor="skills" className="text-[10px] font-black uppercase tracking-widest ml-1 text-black/60">Key Skills</Label>
                                    <Input id="skills" placeholder="e.g. First Aid, Driving, Translation" className="h-14 rounded-xl bg-gray-50 border-none font-bold placeholder:text-black/30" value={formData.skills} onChange={handleChange} />
                                </div>
                                
                                <div className="space-y-2">
                                    <Label htmlFor="interests" className="text-[10px] font-black uppercase tracking-widest ml-1 text-black/60">Primary Interests</Label>
                                    <Input id="interests" placeholder="e.g. Disaster Relief, Health Services" className="h-14 rounded-xl bg-gray-50 border-none font-bold placeholder:text-black/30" value={formData.interests} onChange={handleChange} />
                                </div>
